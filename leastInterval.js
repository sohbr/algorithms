...
var leastInterval = function(tasks, n) {
    ...
    let counter = {};
    //iterate through tasks and put into a counter hash
    tasks.forEach(task => {
        if (!counter[task]) counter[task] = 0;
        counter[task]++;
    });
    console.log(counter);
    //find the number of highest occuring tasks
    let max = 0;
    let maxTies = 0;
    ...
    //return the least number of intervals to complete all tasks
    let interval = (max - 1) * (n + 1) + maxTies;
